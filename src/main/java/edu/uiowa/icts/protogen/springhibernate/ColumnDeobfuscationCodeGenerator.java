...
public class ColumnDeobfuscationCodeGenerator extends AbstractSpringHibernateCodeGenerator {
	...
	private void generateFunctionsClass( String className, Schema schema ) throws IOException {
		...
		out.write( " * @see <a href=\"https://github.com/ui-icts/protogen\">https://github.com/ui-icts/protogen</a>\n" );
		...
		spaces( out, 8 );
		out.write( "String newCol = " + schema.getLowerLabel() + "DaoService.get" + relabel( (String) properties.get( "dictionary.table.name" ), true ) + "Service().getAlternateColumnName(table, column);\n" );
		spaces( out, 8 );
